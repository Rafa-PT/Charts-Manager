...
const airports = {
  LPPT: {
    name: "Lisbon",
    GND: [
      { name: "Aerodrome Chart", url: "https://ais.nav.pt/wp-content/uploads/AIS_Files/eAIP_Current/eAIP/graphics/eAIP/LP_AD_2_LPPT_01-1_en.pdf", priority: true }
    ],
    runways: {
...
function selectTab(type, el) {
  ...
  let charts = type==="GND"?currentAirport.GND:(currentAirport.runways[currentRunway][type]||[]);
